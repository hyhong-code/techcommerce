...
export const PRODUCT_LISTED = "PRODUCT_LISTED";
export const IMAGE_PREVIEWED = "IMAGE_PREVIEWED";
export const IMAGE_PREVIEW_CANCELED = "IMAGE_PREVIEW_CANCELED";
export const IMAGE_LIST_CHANGED = "IMAGE_LIST_CHANGED";
